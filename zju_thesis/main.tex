...
\documentclass[twoside,nocpsupervisor]{zjuthesis}
...
\include{contents/sffd}
\include{contents/clip}
\include{contents/implement}
\include{contents/mobile}
